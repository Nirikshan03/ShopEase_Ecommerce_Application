...
public class ShippingServiceImpl implements ShippingService {
    ...
    @Override
    public ShippingDetails updateShippingAddress(Long shippingId, ShippingDTO shippingDTO) throws ShippingException {
    ...
    @Override
    public void deleteShippingDetails(Long shippingId) throws ShippingException {
        ShippingDetails existing = shippingRepository.findById(shippingId)
                .orElseThrow(() -> new ShippingException("Shipping detail not found"));
